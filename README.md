...
Middleware is a function that acomplishes a task before the https request is handled.

- [x] Describe a Resource?
A Resource is what a client recieves when connecting to an endpoint.
